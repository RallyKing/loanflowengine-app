...
**Governance reconciliation:** Scroll/sheet runtime is **documented authoritatively** in **`docs/governance/runtime-workspace-scroll-authority.md`**; `docs/project-intelligence-summary.md` §3, governance maps, and `AGENTS.md` are aligned. Historical audit call-outs about “sticky/`main` file scroll” describe **deprecated** patterns — do not reintroduce.
