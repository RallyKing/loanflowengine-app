...
1. **Doc ↔ implementation drift** (`docs/project-intelligence-summary.md` §3 still describes sticky/`main` scroll for file workspace; **authoritative** behavior is workspace sheet + delegated scroll — see `docs/workspace-sheet-scroll-model.md`).  
