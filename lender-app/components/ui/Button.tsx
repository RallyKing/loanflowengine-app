...
const variants: Record<Variant, string> = {
  ...
  secondary:
    "border border-border bg-muted/60 text-foreground shadow-dlc-1 hover:bg-muted hover:border-primary/35 hover:shadow-dlc-2 active:bg-muted/80 active:scale-[0.98]",
  outline:
