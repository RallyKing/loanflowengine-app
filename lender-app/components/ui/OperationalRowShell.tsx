    ...
    meta
      ...
      <div className="flex min-w-0 flex-col gap-px overflow-hidden">
        ...
        {secondary ? (
          ...
          <div className={cn("min-w-0 truncate", OP_SCAN_SECONDARY)}>{secondary}</div>

        ) : null}

        {tertiary ? (

          <div className={cn("min-w-0 overflow-hidden", opHoverTertiaryRevealClass())}>
  ...
  return (
    ...
    >
      ...
      <RowShell
        ...
        meta={metaContent ? <RowShellMetadata>{metaContent}</RowShellMetadata> : undefined}
