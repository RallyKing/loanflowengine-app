...
export const saveContactReo = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const id = await ctx.db.insert("contactReoProperties", {
      ...
      zillowUrl: args.patch.zillowUrl,
      ...
      lotSf: args.patch.lotSf,
      propSf: args.patch.propSf,
      mostRecent: args.patch.mostRecent,
      createdAt: now,
      updatedAt: now,
    });
...
export const saveContactBusinessDebt = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const id = await ctx.db.insert("contactBusinessDebtSchedules", {
      ...
      monthlyPayment: args.patch.monthlyPayment,
      position: args.patch.position,
      debtType: args.patch.debtType,
      debtTypeOther: args.patch.debtTypeOther,
      originalAmount: args.patch.originalAmount,
      originationDate: args.patch.originationDate,
      ratePct: args.patch.ratePct,
      maturityDate: args.patch.maturityDate,
      createdAt: now,
      updatedAt: now,
    });
