#!/usr/bin/env node
/**
 * Phase 25.1b — run contact roles migration on production Convex.
 * Usage: node scripts/run-contact-roles-migration.mjs [--dry-run]
 */
...
const result = spawnSync(
  process.execPath,
  [bin, "run", "migrations/contactRolesMigration:migrateContactRolesAndPurgeLabels", args],
