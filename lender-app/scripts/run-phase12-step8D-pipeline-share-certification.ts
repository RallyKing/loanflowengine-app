#!/usr/bin/env npx tsx
/**
 * Phase 12.2 Step 8D — pipeline file share certification (production).
 */
...
async function main() {
  ...
  const proof = convexRun(
    "operator/pipelineShareCertificationStep8D:runPipelineShareCertification",
    { adminSecret },
  );
  ...
  writeFileSync(
    join(reportsDir, "phase12-step8D-pipeline-share-certification.json"),
